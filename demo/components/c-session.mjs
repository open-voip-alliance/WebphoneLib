...
window.customElements.define('c-session',
...
async handleEvent(e) {
  ...
  connectedCallback() {
    ...
    this.nodes.sessionDirection.innerText = this.session.isIncoming ? 'incoming call' : 'outgoing call';

    [this.actions.accept, this.actions.reject, this.actions.cancel, this.actions.toggleTransfer, this.actions.toggleDTMF, this.actions.hold, this.actions.unhold, this.actions.hangup, this.nodes.additionalInterface].forEach(n =>{
