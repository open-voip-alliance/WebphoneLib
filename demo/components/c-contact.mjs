...
window.customElements.define('c-contact',
class extends HTMLElement {
  ...
  // zou ook op de toasts manier kunnen vanuit de webphone -> dus ze hebben een id en een close functie.
  // dan kun je vanaf c-contacts een contact sluiten en heeft alleen c-contacts de event listener. Dus contacts is in charge van het sluiten van een contact.
