...
// const inputSelect = document.querySelector('[data-selector="inputSelect"]');
// const outputSelect = document.querySelector('[data-selector="outputSelect"]');
// const inputDevicesList = document.querySelector('[data-selector="inputDevicesList"]');
// const outputDevicesList = document.querySelector('[data-selector="outputDevicesList"]');
